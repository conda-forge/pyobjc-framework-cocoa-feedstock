...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pyobjc-framework-cocoa-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyobjc-framework-cocoa-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyobjc-framework-cocoa
# for installing globally
pixi global install pyobjc-framework-cocoa
```
...
It is possible to list all of the versions of `pyobjc-framework-cocoa` available on your platform:
...
```
pixi search pyobjc-framework-cocoa --channel conda-forge
```
